...
the boot file must have two things:
	1) an ignored import of all of the workflows. all workflows you wish to use must be exported, package level
		variables, initialized with zenaton.NewWorkflow(). See for example in: github.com/zenaton/zenaton-go/workflows/workflows
...
import (
	...
	_ "github.com/zenaton/examples-go/workflow"
	// (2)
